...
![A trace and its spans in the telemetry.dev dashboard](/dashboard-trace.png)
...
```mermaid
flowchart LR
  SDK["SDK or OpenTelemetry exporter"] -->|"OTLP/HTTP"| Ingest["ingest.telemetry.dev"]
  Ingest -->|"normalized trace and span fields"| Dash["Dashboard"]
```
