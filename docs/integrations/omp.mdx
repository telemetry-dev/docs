...
:::note
`@telemetry-dev/omp` is not on the public npm registry yet. The integration ships with the next release.
:::
...
After the public release, install the package where Oh My Pi can resolve it. Then add one of these files:
